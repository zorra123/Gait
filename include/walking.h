...
namespace darwin {
    ...
    public:
        ...
        int current_phase() const noexcept { return m_phase; }

        double body_swing_y() const noexcept { return m_body_swing_y; }

        double body_swing_z() const noexcept { return m_body_swing_z; }
